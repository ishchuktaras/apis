...
// --- GENERÁTOR HTML EMAILU ---
const generateEmailHtml = (clientName: string, salonName: string, date: string, time: string, serviceName: string, price: number, cancelLink: string, salonAddress: string) => {
  return `
<!DOCTYPE html>
<html>
<head>
